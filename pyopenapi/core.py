...
class SwaggerApp(object):
    ...
    def __init__(self, url=None, app_cache=None, url_load_hook=None, sep=consts.private.SCOPE_SEPARATOR, prim=None):
        ...
        :param prim pyopenapi.primitives.SwaggerPrimitive: factory for primitives in Swagger.
        """
    ...
    def prim_factory(self):
        ...
        :type: pyopenapi.primitives.SwaggerPrimitive
        """
        return self.__prim
...
class BaseClient(object):
    ...
    def prepare_schemes(self, req):
        ...
        :param pyopenapi.io.SwaggerRequest req: current request object
        """
