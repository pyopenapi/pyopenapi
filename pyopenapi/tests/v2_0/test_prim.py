from pyopenapi import App, primitives, errs, io
...
class SchemaTestCase(unittest.TestCase):
    ...
    def test_float_dump(self):
        ...
        refer to issue: https://github.com/mission-liao/pyopenapi/issues/92
        """
...
class ParameterTestCase(unittest.TestCase):
    ...
    def test_collection_format_default(self):
        ...
        refer to issue: https://github.com/mission-liao/pyopenapi/issues/101
        """
...
class PrimitiveExtensionTestCase(unittest.TestCase):
    ...
    def setUpClass(kls):
        ...
        def str_no_validate(obj, val, ctx):
            # same as the one used in pyopenapi, but no validation
            return str(val)
