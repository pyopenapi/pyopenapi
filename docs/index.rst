.. pyopenapi documentation master file, created by
   sphinx-quickstart on Tue Sep  2 20:23:09 2014.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to pyopenapi's documentation!
=====================================

**pyopenapi** is a type-safe, dynamic, spec-complaint Swagger client.

- *type-safe*: Instead of manipulating json files as objects directly, we load them and produce our own object set. Every object in `Swagger spec <https://github.com/wordnik/swagger-spec>`_ has a correspondence in pyopenapi. During construction of those objects, rules of Swagger Spec would be checked.
- *dynamic*: Unlike `swagger-codegen <https://github.com/wordnik/swagger-codegen>`_, pyopenapi doesn't need preprocessing.
- *spec-complaint*: pyopenapi support Swagger 1.2.

The main idea of pyopenapi is to provide something easier to use than raw json, and develop things around that.
...
===============
    ...
    .. code-block:: python
        ...
        from pyopenapi import SwaggerApp, SwaggerSecurity
